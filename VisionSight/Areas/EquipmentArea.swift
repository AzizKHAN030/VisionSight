    ...
    var body: some View {
        ...
        HStack {
            VStack {
                ...
                Toggle(model.isShowingRocketCapsule ? "Hide Rocket Capsule" : "Show Rocket Capsule", isOn: $model.isShowingRocketCapsule)
            ...
            VStack {
                ...
                Toggle(model.isShowingFullRocket ? "Hide Rocket (Volumentric)" : "Show Rocket (Volumetric)", isOn: $model.isShowingFullRocket)
